...
const styles = StyleSheet.create({
  ...
  sectionLabel:       { paddingHorizontal: 24, fontSize: 11, fontWeight: '900', letterSpacing: 6, color: C.outline, textTransform: 'uppercase', marginBottom: 18 },
  listContainer:      { paddingHorizontal: 16 },
  entryWrapper:       { marginBottom: 14 },
  entryTile:          { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#fff', borderRadius: 24, padding: 18, borderWidth: 1, borderColor: 'rgba(169,180,185,0.06)', shadowColor: '#000', shadowOffset: { width:0, height:4 }, shadowOpacity:0.03, shadowRadius:6 },
  ...
  badgeNew:           { paddingHorizontal: 8, paddingVertical: 4, backgroundColor: 'rgba(78,90,154,0.06)', borderRadius: 8 },
